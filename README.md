...
## Download link: 
Rushia Mod v1.1.6 - (See release download for newest version.)
Note: There will be no game bundled for this update. Kindly download any previous version first before download the latest release version.
